            ...
            if ($item->parent_id == (int) $settings['parent'])
            {
                ...
                <div>
                    ...
                    <span class="action-buttons">
                            ...
                            <a href="<?= Url::toRoute(['/pages/page/update', 'id' => $item->entity_id, 'referrer' => 'menu-items']) ?>" data-toggle="tooltip" title="<?= Yii::t('app', 'Edit {modelClass}', ['modelClass' => strtolower(Yii::t('fonclub/pages', 'Page'))]) ?>">
