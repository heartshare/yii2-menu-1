...
class MenuItem extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            /*['parent_id', function($attribute, $params) {
                mail('fabio@fonclub.be', __FILE__.' => '.__LINE__, '');
                if ($this->level > $model->menu->max_level - 1)
                    $this->addError($attribute, Yii::t('fonclub/menu', 'The maximum level has been reached'));    
            }]*/
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'menu_id' => Yii::t('fonclub/menu', 'Menu ID'),
            'parent_id' => Yii::t('fonclub/menu', 'Parent ID'),
            'entity' => Yii::t('app', 'Entity'),
            'entity_id' => Yii::t('app', 'Entity ID'),
            'level' => Yii::t('fonclub/menu', 'Level'),
            'name' => Yii::t('app', 'Name'),
            'url' => Yii::t('app', 'Url'),
